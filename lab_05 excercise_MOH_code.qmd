...
Okay, we should play around with even more TCR-sequences, HLA-types and HLA-alleles. Kind of irrelevant. What is the most interesting is which peptides bind most strongly to the different HLA-classes.
...
It is more interesting to look at peptide binding motifs to frequenlty occurring HLA-alleles. Looking at HLA-A*03, HLA-A*26, HLA-B*27:02 and HLA-B*57 we can do the following analysis.
...
Among the three alleles we can see strong evidence to determine that positions 2 and 9 of the 9-mer peptides are responsible for the high binding affinity, where the amino acid L is most predominant for both positions in the alleles studied.
